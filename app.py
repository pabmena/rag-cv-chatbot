...
if ollama_model:
    ...
    st.sidebar.success(f"Claude activo: `{anth_model}`")
elif openai_key:
    openai_model = os.getenv("OPENAI_MODEL", "gpt-4o-mini")
    st.sidebar.success(f"OpenAI activo: `{openai_model}`")
else:
    st.sidebar.warning("No hay motor configurado. Seteá OLLAMA_MODEL o OPENAI_API_KEY o ANTHROPIC_API_KEY.")
